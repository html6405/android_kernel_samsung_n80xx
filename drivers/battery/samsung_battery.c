...
charge_ok:
	...
	case POWER_SUPPLY_TYPE_BATTERY:
		...
		printk("Kernel: POWER_SUPPLY_TYPE_BATTERY\n");
		break;
	case POWER_SUPPLY_TYPE_MAINS:
		charge_info_level = ac_level;
		sprintf(charge_info_text, "AC Charger");
		printk("Kernel: POWER_SUPPLY_TYPE_MAINS, using charge rate %d mA\n", ac_level);
	...
	case POWER_SUPPLY_TYPE_USB:
		...
		printk("Kernel: POWER_SUPPLY_TYPE_USB, using charge rate %d mA\n", usb_level);
	...
	case POWER_SUPPLY_TYPE_USB_CDP:
		...
		printk("Kernel: POWER_SUPPLY_TYPE_USB_CDP, using charge rate %d mA\n", ac_level);
	...
	case POWER_SUPPLY_TYPE_DOCK:
		printk("Kernel: POWER_SUPPLY_TYPE_DOCK\n");
		if (!info->pdata->suspend_chging)
			wake_lock(&info->charge_wake_lock);
		...
		case CABLE_TYPE_AUDIODOCK_MUIC:
			...
			printk("Kernel: CABLE_TYPE_AUDIODOCK_MUIC, using charge rate %d mA\n", ac_level);
		...
		case CABLE_TYPE_SMARTDOCK_TA_MUIC:
			if (info->cable_sub_type == ONLINE_SUB_TYPE_SMART_OTG) {
				...
				printk("Kernel: CABLE_TYPE_SMARTDOCK_TA_MUIC (with host), using charge rate %d mA\n", ac_level);
				...
				printk("Kernel: CABLE_TYPE_SMARTDOCK_TA_MUIC (no host), using charge rate %d mA\n", ac_level);
		...
		case CABLE_TYPE_SMARTDOCK_USB_MUIC:
			...
			printk("Kernel: CABLE_TYPE_SMARTDOCK_USB_MUIC, using charge rate %d mA\n", ac_level);
		...
		default:
			...
			printk("Kernel: Default, using charge rate %d mA\n", ac_level);
	...
	case POWER_SUPPLY_TYPE_WIRELESS:
		...
		printk("Kernel: POWER_SUPPLY_TYPE_WIRELESS");
