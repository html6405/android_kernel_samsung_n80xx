...
int charge_level_init(void)
{
	...
	{
		printk("Kernel: failed to create kernel object for charge level interface.\n");
		return -ENOMEM;
	}
	...
	if (charge_level_retval)
	{
		...
		printk("Kernel: failed to create fs object for charge level interface.\n");
		return (charge_level_retval);
	}

	// print debug info
	printk("Kernel: charge level interface started.\n");
...
void charge_level_exit(void)
{
	...
	// print debug info
	printk("Kernel: charge level interface stopped.\n");
}
